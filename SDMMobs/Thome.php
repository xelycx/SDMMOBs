...
<!-- Navigation bar -->
<div class="navbar">
  <a href="Thome.php" class="w3-bar-item w3-button">Home <i class="fa fa-home"></i></a>
  <div class="dropdown">
    <button class="dropbtn">Triager Account <i class='fa fa-user'></i> 
      <i class="fa fa-caret-down"></i>
    </button>
    <div class="dropdown-content"> 
      <!--update status and update & assign developer comment -->
      <a href="ReportBug.php">View Open status </a>
      <a href="ReportBug.php">View Reviewed status </a>
      <a href="ReportBug.php">Generate Report</a>
